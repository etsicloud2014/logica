...
public class Clasificador {
	public static void main(String[] args){
		Clasificador.clasificar("/home/alumno/workspace/logica/src/nuevo_fich_parseado.xml");
	}
    public static void clasificar(String path){
		DiccionarioXml dic = new DiccionarioXml("/home/alumno/workspace/logica/src/palabras.xml");
